...
String.prototype.shout = function() {
	//Set every character in a string to uppercase
	//Add 5 bangs to the end of the string. 
...
function CharacterCreator(name, health, specialSkill) {
	this.name = name;
	this.health = health;
	this.specialSkill = specialSkill;
}

var sharkeisha = new CharacterCreator('Sharkeisha', 9001, 'Unexpected Haymaker');
console.log(sharkeisha);
...
//I have no idea why this keeps returning a syntax error.

// CharacterCreator.prototype.fullHeal(health) {
